...
2. **Distribute:** Tell each team member to DM Clark and say "start the assessment"
3. **Collect:** Each person's assessment ends with a JSON code block. They copy it and send it to you (or Clark can be configured to save it automatically)
...
- **Isolated** — each DM is independent, no cross-contamination
